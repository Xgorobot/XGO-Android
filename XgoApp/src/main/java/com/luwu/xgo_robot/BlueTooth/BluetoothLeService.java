...
public class BluetoothLeService extends Service {
    ...
    public final static String ACTION_WRITE_RESULT =
            "com.example.bluetooth.le.ACTION_WRITE_RESULT";
    ...
    public final static UUID UUID_MESSAGE_CAR = UUID.fromString(SampleGattAttributes.MESSAGE_GATT);
    ...
    private final BluetoothGattCallback mGattCallback = new BluetoothGattCallback() {
        ...
        public void onConnectionStateChange(BluetoothGatt gatt, int status, int newState) {
            ...
            if (newState == BluetoothProfile.STATE_CONNECTED) {
                ...
                boolean successed = mBluetoothGatt.discoverServices();
                Log.i(TAG, "Attempting to start service discovery:" + successed);
                //如果未发现服务
                if (!successed) {
    ...
    public BluetoothGatt getMsgBluetoothGatt() {
